...
export default function HeroSection() {
  return (
    <div 
      className="relative bg-slate-900 text-white py-36 px-8 text-center bg-cover bg-center min-h-[85vh] flex flex-col items-center justify-center" 
      style={{ backgroundImage: `linear-gradient(rgba(36, 87, 67, 0.4), rgba(15, 70, 56, 0.6)), url('/herp.PNG')` }}
    >
